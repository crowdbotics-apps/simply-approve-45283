"""
Django settings for simply_approve_45283 project.
...
ROOT_URLCONF = 'simply_approve_45283.urls'
...
WSGI_APPLICATION = 'simply_approve_45283.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "simply_approve_45283 API",
    "DESCRIPTION": "API documentation for simply_approve_45283 App",
    "VERSION": "v1",
}
